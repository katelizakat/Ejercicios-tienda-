package com.prueba.automationtest.glue.demo;

import com.prueba.automationtest.model.demo.Customer;
import com.prueba.automationtest.questions.QuesGetText;
import com.prueba.automationtest.tasks.demo.*;
import com.prueba.automationtest.tasks.demo.retrieveusername.ProccessRetrieveUserName;
import com.prueba.automationtest.tasks.demo.retrieveusername.RetrieveData;
import com.prueba.automationtest.tasks.demo.retrieveusername.UseRetrievedData;
import com.prueba.automationtest.tasks.demo.retrieveusername.enums.VarMsGraph;
import com.prueba.automationtest.ui.demo.*;
...
import static com.prueba.automationtest.ui.demo.PageCart.SUCCESSFULL_PURCHASE;
...
public class SerenityBDDWebGlue {
    ...
    @Given("que el {actor} ingresa a la pagina de demoblaze para seleccionar el {string} y el {string}")
    public void queElActorIngresaALaPaginaDeDemoblazeParaSeleccionarEl(Actor actor, String description, String description2) {
        ...
        andThat(actor).wasAbleTo(
                FindProduct.whitDescription(description2),
                AddProducts.toCart(description2)
        );
    }
